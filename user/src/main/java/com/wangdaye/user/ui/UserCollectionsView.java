...
public class UserCollectionsView extends FitBottomSystemBarBothWaySwipeRefreshLayout
    ...
    public UserCollectionsView(UserActivity a, CollectionAdapter adapter, int index, PagerManageView v) {
        super(a);
