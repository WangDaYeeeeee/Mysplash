package com.wangdaye.main.following.ui.decoration;
...
public class FollowingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
        ...
        int type = adapter.getItemViewType(params.getViewAdapterPosition());
        if (type == FollowingFeedFragment.HOLDER_TYPE_PHOTO) {
            if (spanCount == 1) {
                outRect.set(
