...
public class HorizontalScrollableImageView extends AppCompatImageView
    ...
    public HorizontalScrollableImageView(Context context, AttributeSet attrs) {
        super(context, attrs);

        imageMatrix = new Matrix();
        matrixValues = new float[9];

        translateX = minTranslateX = maxTranslateX = 0;
    ...
    protected int computeHorizontalScrollRange() {
        return (int) (viewWidth + maxTranslateX - minTranslateX);
    }
    ...
    public boolean isAlignCenter() {
        return getScaleType() == ScaleType.CENTER_CROP
                || translateX == (minTranslateX + maxTranslateX) / 2;
    }
