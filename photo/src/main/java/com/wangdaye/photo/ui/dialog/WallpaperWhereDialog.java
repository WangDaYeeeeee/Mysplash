...
public class WallpaperWhereDialog extends MysplashDialogFragment {
    ...
    @BindView(R2.id.dialog_wallpaper_where_container) CoordinatorLayout container;
    @BindView(R2.id.dialog_wallpaper_where_progress) CircularProgressView progressView;
    @BindView(R2.id.dialog_wallpaper_where_selector) LinearLayout selector;

    @OnClick(R2.id.dialog_wallpaper_where_wallpaper) void clickWallpaper() {
        if (listener != null) {
    ...
    @OnClick(R2.id.dialog_wallpaper_where_lockscreen) void clickLockScreen() {
        if (listener != null) {
    ...
    @OnClick(R2.id.dialog_wallpaper_where_all) void clickAll() {
        if (listener != null) {
