...
public class Photo
        implements Parcelable, Previewable, ReadWriteActivity.Downloadable {
    // data
    ...
    public String getRegularSizeUrl(Context context) {
        return getRegularSizeUrl(getRegularSize(context));
    }

    public String getRegularSizeUrl(@Size(2) int[] size) {
        return urls.raw
                + "?q=75&fm=jpg"
                + "&w=" + size[0]
                + "&h=" + size[1]
