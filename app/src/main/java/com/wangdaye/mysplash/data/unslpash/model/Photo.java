...
public class Photo {
    ...
    public static class CurrentUserCollections {
         ...
         * username : crew
         * name : Crew
         * bio : Work with the best designers and developers without breaking the bank. Creators of Mysplash.
