...
public class ExifHolder extends PhotoInfoAdapter3.ViewHolder {
    ...
    @BindView(R.id.item_photo_3_exif)
    LinearLayout container;

    @BindView(R.id.item_photo_3_exif_icon)
    AppCompatImageView icon;

    @BindView(R.id.item_photo_3_exif_title)
    TextView title;

    @BindView(R.id.item_photo_3_exif_content)
    TextView content;

    @BindView(R.id.item_photo_3_exif_color)
    FrameLayout color;
