package com.wangdaye.about.presenter;
...
import com.wangdaye.about.model.HeaderObject;
...
public class CreateAboutModelPresenter {
    ...
    public static List<AboutModel> createModelList(Context c) {
        ...
        // donate.
        modelList.add(new CategoryObject(c.getString(R.string.donate)));
        modelList.add(new AppObject(
                5,
                R.drawable.ic_alipay,
                c.getString(R.string.donate_alipay)));
        modelList.add(new AppObject(
                6,
                R.drawable.ic_wechat,
                c.getString(R.string.donate_wechat)));
